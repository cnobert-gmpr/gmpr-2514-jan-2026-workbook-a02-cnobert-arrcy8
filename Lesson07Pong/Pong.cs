...
public class Pong : Game
{
    ...
    internal Rectangle PlayAreaBoundingBox
    {
        get
        {
            return new Rectangle(0, _PlayAreaEdgeLineWidth, _WindowWidth, _WindowHeight);
        }
    }
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        if(_ballPosition.Y <= PlayAreaBoundingBox.Top + _PlayAreaEdgeLineWidth ||
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        Rectangle leftPaddleRectangle = new Rectangle((int) _leftPaddlePosition.X, (int) _leftPaddlePosition.Y, (int) _leftPaddleDimensions.X, (int) _leftPaddleDimensions.Y);
